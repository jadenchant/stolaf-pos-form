...
const otherElectiveData = [
  {id: 'csci200', name: 'Topics in CS', prerequisite: ['varies']},
  {id: 'csci300', name: 'Topics in CS', prerequisite: ['varies']},
  {id: 'csci284', name: 'Mobile Computing Applications', prerequisite: ['csci251']},
  {id: 'csci336', name: 'Logic Programming', prerequisite: ['csci251']},
  {id: 'csci356', name: 'Parallel and Distributed Systems', prerequisite: ['csci241', 'csci251']},
  {id: 'csci390', name: 'Senior Capstone', prerequisite: ['csci263', 'csci353']},
  {id: 'csci391', name: 'Senior Capstone', prerequisite: ['csci263', 'csci353']},
  {id: 'math282', name: 'Computational Geometry', prerequisite: ['none']},
  {
    id: 'mscs341',
    name: 'Algorithms for Decision Making',
    prerequisite: ['csci251', 'math220', 'stat272'],
  },
  {id: 'phys246', name: 'Electronics', prerequisite: ['phys125', 'phys131']},
];
  ...
  return (
    <div className="w-96">
      ...
      <div className="">
        ...
        <h3>
          <span className="font-bold">Designated:</span> Select at least 2 classes
        </h3>
        {electiveSelect(electiveData)}
        <h3>
          <span className="font-bold">Other Electives</span>
        </h3>
